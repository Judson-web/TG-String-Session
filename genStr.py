...
By <a href="https://t.me/VAMPIRE_KING_NO_1">ᗪᗩᖇK ✞Oᖇᗪ</a>
...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@PC_String_Session_bot](tg://openmessage?user_id=1472531255) \nA Bot By @VAMPIRE_KING_NO_1")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/movies_hub52'),
                InlineKeyboardButton('Developer', url='https://t.me/VAMPIRE_KING_NO_1')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/storytimeoG'),
            ]
        ]
    )
